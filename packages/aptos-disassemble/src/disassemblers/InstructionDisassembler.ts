 ...
 */
import { Bytecode } from '../types/MoveModule';
...
export class InstructionDisassembler {
    ...
    disassemble(instruction: Bytecode): string {
        switch (instruction.kind) {
            ...
            case "PackVariantGeneric":
                return this.formatGenericVariantOperation(instruction.structVariantInstIdx, "PackVariantGeneric");
            case "UnpackVariantGeneric":
                return this.formatGenericVariantOperation(instruction.structVariantInstIdx, "UnpackVariantGeneric");
            case "TestVariantGeneric":
                return this.formatGenericVariantOperation(instruction.structVariantInstIdx, "TestVariantGeneric");
            ...
            case "MutBorrowVariantField":
                return this.formatVariantFieldOperation(instruction.variantFieldHandleIdx, "MutBorrowVariantField");
            case "ImmBorrowVariantField":
                return this.formatVariantFieldOperation(instruction.variantFieldHandleIdx, "ImmBorrowVariantField");
            case "MutBorrowVariantFieldGeneric":
                return this.formatGenericVariantFieldOperation(instruction.variantFieldInstIdx, "MutBorrowVariantFieldGeneric");
            case "ImmBorrowVariantFieldGeneric":
                return this.formatGenericVariantFieldOperation(instruction.variantFieldInstIdx, "ImmBorrowVariantFieldGeneric");
            ...
            case "MutBorrowGlobalGeneric":
                return this.formatGenericStructOperation(instruction.structInstIdx, "MutBorrowGlobalGeneric");
            case "ImmBorrowGlobalGeneric":
                return this.formatGenericStructOperation(instruction.structInstIdx, "ImmBorrowGlobalGeneric");
            case "Exists":
            ...
            // Vector operations
            case "VecPack":
                return this.formatVectorOperation(instruction.elemTyIdx, instruction.numElements, "VecPack");
            case "VecLen":
            ...
            case "VecUnpack":
                return this.formatVectorOperation(instruction.elemTyIdx, instruction.numElements, "VecUnpack");
            case "VecSwap":
                return this.formatVectorOperation(instruction.elemTyIdx, undefined, "VecSwap");

            default:
                throw new Error(`Unsupported instruction: ${(instruction as any).kind}`);
        }
    }
    ...
    private formatCall(funcHandleIdx: number): string {
        ...
        const typeArguments = functionHandle.type_parameters.map(tp => this.context.parseAbilities(tp));
    ...
    private formatGenericStructOperation(structInstIdx: number, instructionName: string): string {
        ...
        const structHandle = this.context.getStructHandle(structDef.struct_handle);
        const structName = this.context.getIdentifier(structHandle.name);
        const typeParams = this.context.getSignature(structInst.typeParameters)
    ...
    private formatGenericVariantOperation(structVariantInstIdx: number, instructionName: string): string {
    ...
    private formatVariantFieldOperation(variantFieldHandleIdx: number, instructionName: string): string {
    ...
    private formatGenericVariantFieldOperation(variantFieldInstIdx: number, instructionName: string): string {
    ...
    private formatVectorOperation(elemTyIdx: number, numElements: bigint | undefined, instructionName: string): string {
    ...
    private formatConstantData(data: Uint8Array, type: any): string {
    ...
    private getFieldInfo(fieldHandle: any): { structName: string; fieldName: string; fieldType: string } {
    ...
    private getVariantInfo(structVariantHandle: any): { structName: string; variantName: string } {
